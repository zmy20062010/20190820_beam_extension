...
%% Unimorph, Rl from 1 ohm to 10 Mohm
results0 = load('bm_uni_base_Rl_1e0', 'Vplist', 'frlist', 'xib'); 
Vplist0 = results0.Vplist;
results1 = load('bm_uni_base_Rl_1e1', 'Vplist'); 
Vplist1 = results1.Vplist;
results2 = load('bm_uni_base_Rl_1e2', 'Vplist'); 
Vplist2 = results2.Vplist;
results3 = load('bm_uni_base_Rl_1e3', 'Vplist'); 
Vplist3 = results3.Vplist;
results4 = load('bm_uni_base_Rl_1e4', 'Vplist'); 
Vplist4 = results4.Vplist;
results5 = load('bm_uni_base_Rl_1e5', 'Vplist'); 
Vplist5 = results5.Vplist;
results6 = load('bm_uni_base_Rl_1e6', 'Vplist'); 
Vplist6 = results6.Vplist;
results7 = load('bm_uni_base_Rl_1e7', 'Vplist'); 
