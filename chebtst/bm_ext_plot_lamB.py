...
def plot_vol_lamB_vs_fr_Rl():
    ...
    plt.text(0.02, 0.93, "(c)", fontweight="bold", transform=ax[0,2].transAxes, fontsize=24)
    plt.text(0.02, 0.93, "(d)", fontweight="bold", transform=ax[1,0].transAxes, fontsize=24)
    plt.text(0.02, 0.93, "(e)", fontweight="bold", transform=ax[1,1].transAxes, fontsize=24)
    plt.text(0.02, 0.93, "(f)", fontweight="bold", transform=ax[1,2].transAxes, fontsize=24)
...
def plot_vol_lamB_list_vs_fr_Rl():
    fig, axes = plt.subplots(ncols = 3, nrows = 2, figsize=(24,12), sharex=True)
    ...
    axes[0,0].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[2][0], lamB_list[2][0]), fontsize=18)
    ...
    axes[0,1].plot(Rl[:,0],am_vplist11[:,200], 'r-*', label='fr=10 $Hz$')
    axes[0,1].plot(Rl[:,0],am_vplist11[:,300], 'g-.', label='fr=31.62 $Hz$')
    axes[0,1].plot(Rl[:,0],am_vplist11[:,325], 'b--', label='fr=42.17 $Hz$')
    axes[0,1].plot(Rl[:,0],am_vplist11[:,350], 'm-', label='fr=56.23 $Hz$')
    axes[0,1].plot(Rl[:,0],am_vplist11[:,375], 'c-d', label='fr=74.99 $Hz$')
    axes[0,1].plot(Rl[:,0],am_vplist11[:,400], 'k-o', label='fr=100 $Hz$')
    # axes[0,1].set_xscale('log')
    axes[0,1].set_yscale('log')
    axes[0,1].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[11][0], lamB_list[11][0]), fontsize=18)
    ...
    axes[0,2].plot(Rl[:,0],am_vplist13[:,200], 'r-*', label='fr=10 $Hz$')
    axes[0,2].plot(Rl[:,0],am_vplist13[:,300], 'g-.', label='fr=31.62 $Hz$')
    axes[0,2].plot(Rl[:,0],am_vplist13[:,325], 'b--', label='fr=42.17 $Hz$')
    axes[0,2].plot(Rl[:,0],am_vplist13[:,350], 'm-', label='fr=56.23 $Hz$')
    axes[0,2].plot(Rl[:,0],am_vplist13[:,375], 'c-d', label='fr=74.99 $Hz$')
    axes[0,2].plot(Rl[:,0],am_vplist13[:,400], 'k-o', label='fr=100 $Hz$')
    # axes[0,2].set_xscale('log')
    axes[0,2].set_yscale('log')
    axes[0,2].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[13][0], lamB_list[13][0]), fontsize=18)
    ...
    axes[1,0].plot(Rl[:,0],am_vplist14[:,200], 'r-*', label='fr=10 $Hz$')
    axes[1,0].plot(Rl[:,0],am_vplist14[:,300], 'g-.', label='fr=31.62 $Hz$')
    axes[1,0].plot(Rl[:,0],am_vplist14[:,325], 'b--', label='fr=42.17 $Hz$')
    axes[1,0].plot(Rl[:,0],am_vplist14[:,350], 'm-', label='fr=56.23 $Hz$')
    axes[1,0].plot(Rl[:,0],am_vplist14[:,375], 'c-d', label='fr=74.99 $Hz$')
    axes[1,0].plot(Rl[:,0],am_vplist14[:,400], 'k-o', label='fr=100 $Hz$')
    # axes[1,0].set_xscale('log')
    axes[1,0].set_yscale('log')
    axes[1,0].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[14][0], lamB_list[14][0]), fontsize=18)
    ...
    axes[1,1].plot(Rl[:,0],am_vplist23[:,200], 'r-*', label='fr=10 $Hz$')
    axes[1,1].plot(Rl[:,0],am_vplist23[:,300], 'g-.', label='fr=31.62 $Hz$')
    axes[1,1].plot(Rl[:,0],am_vplist23[:,325], 'b--', label='fr=42.17 $Hz$')
    axes[1,1].plot(Rl[:,0],am_vplist23[:,350], 'm-', label='fr=56.23 $Hz$')
    axes[1,1].plot(Rl[:,0],am_vplist23[:,375], 'c-d', label='fr=74.99 $Hz$')
    axes[1,1].plot(Rl[:,0],am_vplist23[:,400], 'k-o', label='fr=100 $Hz$')
    # axes[1,1].set_xscale('log')
    axes[1,1].set_yscale('log')
    axes[1,1].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[23][0], lamB_list[23][0]), fontsize=18)
    ...
    axes[1,2].plot(Rl[:,0],am_vplist32[:,200], 'r-*', label='fr=10 $Hz$')
    axes[1,2].plot(Rl[:,0],am_vplist32[:,300], 'g-.', label='fr=31.62 $Hz$')
    axes[1,2].plot(Rl[:,0],am_vplist32[:,325], 'b--', label='fr=42.17 $Hz$')
    axes[1,2].plot(Rl[:,0],am_vplist32[:,350], 'm-', label='fr=56.23 $Hz$')
    axes[1,2].plot(Rl[:,0],am_vplist32[:,375], 'c-d', label='fr=74.99 $Hz$')
    axes[1,2].plot(Rl[:,0],am_vplist32[:,400], 'k-o', label='fr=100 $Hz$')
    # axes[1,2].set_xscale('log')
    axes[1,2].set_yscale('log')
    axes[1,2].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[32][0], lamB_list[32][0]), fontsize=18)
    axes[1,2].legend(loc='lower right', ncol=2)
    axes[1,2].set_xlabel('Externally connected resistance $R_l$ ($\\Omega$)', fontsize=18)
    ...
    plt.text(0.02, 0.93, "(c)", fontweight="bold", transform=axes[0,2].transAxes, fontsize=24)
    ...
    plt.text(0.02, 0.93, "(f)", fontweight="bold", transform=axes[1,2].transAxes, fontsize=24)
...
def plot_pow_lamB_list_vs_fr_Rl():
    ...
    axes[0,1].plot(Rl[:,0],am_pplist11[:,200], 'r-*', label='fr=10 $Hz$')
    axes[0,1].plot(Rl[:,0],am_pplist11[:,300], 'g-.', label='fr=31.62 $Hz$')
    axes[0,1].plot(Rl[:,0],am_pplist11[:,325], 'b--', label='fr=42.17 $Hz$')
    axes[0,1].plot(Rl[:,0],am_pplist11[:,350], 'm-', label='fr=56.23 $Hz$')
    axes[0,1].plot(Rl[:,0],am_pplist11[:,375], 'c-d', label='fr=74.99 $Hz$')
    axes[0,1].plot(Rl[:,0],am_pplist11[:,400], 'k-o', label='fr=100 $Hz$')
    # axes[0,1].set_xscale('log')
    axes[0,1].set_yscale('log')
    axes[0,1].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[11][0], lamB_list[11][0]), fontsize=18)
    axes[0,1].legend(loc='lower right', ncol=2)
    ...
    axes[0,2].plot(Rl[:,0],am_pplist13[:,200], 'r-*', label='fr=10 $Hz$')
    axes[0,2].plot(Rl[:,0],am_pplist13[:,300], 'g-.', label='fr=31.62 $Hz$')
    axes[0,2].plot(Rl[:,0],am_pplist13[:,325], 'b--', label='fr=42.17 $Hz$')
    axes[0,2].plot(Rl[:,0],am_pplist13[:,350], 'm-', label='fr=56.23 $Hz$')
    axes[0,2].plot(Rl[:,0],am_pplist13[:,375], 'c-d', label='fr=74.99 $Hz$')
    axes[0,2].plot(Rl[:,0],am_pplist13[:,400], 'k-o', label='fr=100 $Hz$')
    # axes[0,2].set_xscale('log')
    axes[0,2].set_yscale('log')
    axes[0,2].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[13][0], lamB_list[13][0]), fontsize=18)
    axes[0,2].legend(loc='lower right', ncol=2)
    # axes[0,2].set_xlabel('Externally connected resistance $R_l$ ($\\Omega$)')
    # axes[0,2].set_ylabel('Amplitude of the output power $P_p$ (W)')

    axes[1,0].plot(Rl[:,0],am_pplist14[:,200], 'r-*', label='fr=10 $Hz$')
    axes[1,0].plot(Rl[:,0],am_pplist14[:,300], 'g-.', label='fr=31.62 $Hz$')
    axes[1,0].plot(Rl[:,0],am_pplist14[:,325], 'b--', label='fr=42.17 $Hz$')
    axes[1,0].plot(Rl[:,0],am_pplist14[:,350], 'm-', label='fr=56.23 $Hz$')
    axes[1,0].plot(Rl[:,0],am_pplist14[:,375], 'c-d', label='fr=74.99 $Hz$')
    axes[1,0].plot(Rl[:,0],am_pplist14[:,400], 'k-o', label='fr=100 $Hz$')
    # axes[1,0].set_xscale('log')
    axes[1,0].set_yscale('log')
    axes[1,0].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[14][0], lamB_list[14][0]), fontsize=18)
    axes[1,0].legend(loc='lower right', ncol=2)
    ...
    axes[1,1].plot(Rl[:,0],am_pplist23[:,200], 'r-*', label='fr=10 $Hz$')
    axes[1,1].plot(Rl[:,0],am_pplist23[:,300], 'g-.', label='fr=31.62 $Hz$')
    axes[1,1].plot(Rl[:,0],am_pplist23[:,325], 'b--', label='fr=42.17 $Hz$')
    axes[1,1].plot(Rl[:,0],am_pplist23[:,350], 'm-', label='fr=56.23 $Hz$')
    axes[1,1].plot(Rl[:,0],am_pplist23[:,375], 'c-d', label='fr=74.99 $Hz$')
    axes[1,1].plot(Rl[:,0],am_pplist23[:,400], 'k-o', label='fr=100 $Hz$')
    # axes[1,1].set_xscale('log')
    axes[1,1].set_yscale('log')
    axes[1,1].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[23][0], lamB_list[23][0]), fontsize=18)
    axes[1,1].legend(loc='lower right', ncol=2)
    ...
    axes[1,2].plot(Rl[:,0],am_pplist32[:,200], 'r-*', label='fr=10 $Hz$')
    axes[1,2].plot(Rl[:,0],am_pplist32[:,300], 'g-.', label='fr=31.62 $Hz$')
    axes[1,2].plot(Rl[:,0],am_pplist32[:,325], 'b--', label='fr=42.17 $Hz$')
    axes[1,2].plot(Rl[:,0],am_pplist32[:,350], 'm-', label='fr=56.23 $Hz$')
    axes[1,2].plot(Rl[:,0],am_pplist32[:,375], 'c-d', label='fr=74.99 $Hz$')
    axes[1,2].plot(Rl[:,0],am_pplist32[:,400], 'k-o', label='fr=100 $Hz$')
    # axes[1,2].set_xscale('log')
    axes[1,2].set_yscale('log')
    axes[1,2].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[32][0], lamB_list[32][0]), fontsize=18)
    axes[1,2].legend(loc='lower right', ncol=2)
...
def plot_vol_fr_sl_Rl_sl_vs_lamB():
    fig, axes = plt.subplots(ncols = 3, nrows = 4, figsize=(18,24), sharex=True)
    ...
    axes[0,0].plot(lamB_list,am_vplist[:, 2, 200], 'r-*', label='fr=10 $Hz$, $R_l$ = 100 $\\Omega$')
    axes[0,0].yaxis.set_major_formatter(yfmt)
    axes[0,0].set_xscale('log')
    axes[0,0].set_ylabel('Amplitude of the output voltage $V_p$ (V)', fontsize=18)

    axes[0,1].plot(lamB_list,am_vplist[:, 4, 200], 'r-*', label='fr=10 $Hz$, $R_l$ = 10 k$\\Omega$')
    axes[0,1].yaxis.set_major_formatter(yfmt)

    axes[0,2].plot(lamB_list,am_vplist[:, 6, 200], 'r-*', label='fr=10 $Hz$, $R_l$ = 1 M$\\Omega$')
    axes[0,2].yaxis.set_major_formatter(yfmt)


    axes[1,0].plot(lamB_list,am_vplist[:, 2, 300], 'r-*', label='fr=31.62 $Hz$, $R_l$ = 100 $\\Omega$')
    axes[1,0].yaxis.set_major_formatter(yfmt)
    axes[1,0].set_ylabel('Amplitude of the output voltage $V_p$ (V)', fontsize=18)

    axes[1,1].plot(lamB_list,am_vplist[:, 4, 300], 'r-*', label='fr=31.62 $Hz$, $R_l$ = 10 k$\\Omega$')
    axes[1,1].yaxis.set_major_formatter(yfmt)

    axes[1,2].plot(lamB_list,am_vplist[:, 6, 300], 'r-*', label='fr=31.62 $Hz$, $R_l$ = 1 M$\\Omega$')
    axes[1,2].yaxis.set_major_formatter(yfmt)


    axes[2,0].plot(lamB_list,am_vplist[:, 2, 325], 'r-*', label='fr=42.17 $Hz$, $R_l$ = 10 $\\Omega$')
    axes[2,0].yaxis.set_major_formatter(yfmt)
    axes[2,0].set_ylabel('Amplitude of the output voltage $V_p$ (V)', fontsize=18)

    axes[2,1].plot(lamB_list,am_vplist[:, 4, 325], 'r-*', label='fr=42.17 $Hz$, $R_l$ = 10 k$\\Omega$')
    axes[2,1].yaxis.set_major_formatter(yfmt)

    axes[2,2].plot(lamB_list,am_vplist[:, 6, 325], 'r-*', label='fr=42.17 $Hz$, $R_l$ = 1 M$\\Omega$')
    axes[2,2].yaxis.set_major_formatter(yfmt)


    axes[3,0].plot(lamB_list,am_vplist[:, 2, 400], 'r-*', label='fr=100 $Hz$, $R_l$ = 100 $\\Omega$')
    ...
    axes[3,1].plot(lamB_list,am_vplist[:, 4, 400], 'r-*', label='fr=100 $Hz$, $R_l$ = 10 k$\\Omega$')
    axes[3,1].yaxis.set_major_formatter(yfmt)
    axes[3,1].set_xlabel('Line density ratio $\\lambda_m$', fontsize=18)

    axes[3,2].plot(lamB_list,am_vplist[:, 6, 400], 'r-*', label='fr=100 $Hz$, $R_l$ = 1 M$\\Omega$')
    ...
    for i in range(4):
        for j in range(3):
            axes[i,j].legend(loc='best', fontsize=18)
    ...
    plt.subplots_adjust(left=0.05, right=0.98, top=0.94, bottom=0.07, wspace=0.15, hspace=0.17)
...
def plot_pow_fr_sl_Rl_sl_vs_lamB():
    ...
    axes[0,0].plot(lamB_list,am_pplist[:, 2, 200], 'r-*', label='fr=10 $Hz$, $R_l$ = 100 $\\Omega$')
    axes[0,0].yaxis.set_major_formatter(yfmt)
    axes[0,0].set_xscale('log')
    axes[0,0].set_ylabel('Amplitude of the output power $P_p$ (W)', fontsize=18)

    axes[0,1].plot(lamB_list,am_pplist[:, 4, 200], 'r-*', label='fr=10 $Hz$, $R_l$ = 10 k$\\Omega$')
    axes[0,1].yaxis.set_major_formatter(yfmt)

    axes[0,2].plot(lamB_list,am_pplist[:, 6, 200], 'r-*', label='fr=10 $Hz$, $R_l$ = 1 M$\\Omega$')
    axes[0,2].yaxis.set_major_formatter(yfmt)


    axes[1,0].plot(lamB_list,am_pplist[:, 2, 300], 'r-*', label='fr=31.62 $Hz$, $R_l$ = 100 $\\Omega$')
    axes[1,0].yaxis.set_major_formatter(yfmt)
    axes[1,0].set_ylabel('Amplitude of the output power $P_p$ (W)', fontsize=18)

    axes[1,1].plot(lamB_list,am_pplist[:, 4, 300], 'r-*', label='fr=31.62 $Hz$, $R_l$ = 10 k$\\Omega$')
    axes[1,1].yaxis.set_major_formatter(yfmt)

    axes[1,2].plot(lamB_list,am_pplist[:, 6, 300], 'r-*', label='fr=31.62 $Hz$, $R_l$ = 1 M$\\Omega$')
    axes[1,2].yaxis.set_major_formatter(yfmt)


    axes[2,0].plot(lamB_list,am_pplist[:, 2, 325], 'r-*', label='fr=42.17 $Hz$, $R_l$ = 10 $\\Omega$')
    axes[2,0].yaxis.set_major_formatter(yfmt)
    axes[2,0].set_ylabel('Amplitude of the output power $P_p$ (W)', fontsize=18)

    axes[2,1].plot(lamB_list,am_pplist[:, 4, 325], 'r-*', label='fr=42.17 $Hz$, $R_l$ = 10 k$\\Omega$')
    axes[2,1].yaxis.set_major_formatter(yfmt)

    axes[2,2].plot(lamB_list,am_pplist[:, 6, 325], 'r-*', label='fr=42.17 $Hz$, $R_l$ = 1 M$\\Omega$')
    axes[2,2].yaxis.set_major_formatter(yfmt)


    axes[3,0].plot(lamB_list,am_pplist[:, 2, 400], 'r-*', label='fr=100 $Hz$, $R_l$ = 100 $\\Omega$')
    axes[3,0].yaxis.set_major_formatter(yfmt)
    axes[3,0].set_ylabel('Amplitude of the output power $P_p$ (W)', fontsize=18)
    axes[3,0].set_xlabel('Line density ratio $\\lambda_m$', fontsize=18)

    axes[3,1].plot(lamB_list,am_pplist[:, 4, 400], 'r-*', label='fr=100 $Hz$, $R_l$ = 10 k$\\Omega$')
    axes[3,1].yaxis.set_major_formatter(yfmt)
    axes[3,1].set_xlabel('Line density ratio $\\lambda_m$', fontsize=18)

    axes[3,2].plot(lamB_list,am_pplist[:, 6, 400], 'r-*', label='fr=100 $Hz$, $R_l$ = 1 M$\\Omega$')
    axes[3,2].yaxis.set_major_formatter(yfmt)
    axes[3,2].set_xlabel('Line density ratio $\\lambda_m$', fontsize=18)
