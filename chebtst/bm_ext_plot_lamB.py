...
def plot_vol_lamB_vs_fr_Rl():
    ...
    ax[0,0].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[0][0], lamB_list[0][0]), fontsize=24)
    ax[0,0].set_xlim(1,100)
    ax[0,0].set_yscale('log')
    # ax[0,0].set_xlabel('Base excitation frequency $f_b$')
    ax[0,0].set_ylabel('Output voltage $|\\tilde{V}_p/(\\sigma^2 \\xi_b)|$ ($V \\cdot s^2 / m$)', fontsize=18)
    # ax[0,0].legend(loc='lower right', ncol=2, fontsize=24)


    ax[0,1].plot(fr[0,:].reshape(-1,1),(am_vplist05[0,:]/xib/wr[0,:]/wr[0,:]).T,'r', label= '$R_l$ = 1 $\\Omega$')
    ax[0,1].plot(fr[0,:].reshape(-1,1),(am_vplist05[2,:]/xib/wr[0,:]/wr[0,:]).T,'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[0,1].plot(fr[0,:].reshape(-1,1),(am_vplist05[4,:]/xib/wr[0,:]/wr[0,:]).T,'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[0,1].plot(fr[0,:].reshape(-1,1),(am_vplist05[6,:]/xib/wr[0,:]/wr[0,:]).T,'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[0,1].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[5][0], lamB_list[5][0]), fontsize=24)
    ax[0,1].set_xlim(1,100)
    ax[0,1].set_yscale('log')
    # ax[0,1].set_xlabel('Base excitation frequency $f_b$')
    # ax[0,1].set_ylabel('Output voltage $|\\tilde{V}_p/(\\sigma^2 \\xi_b)|$ ($V \\cdot s^2 / m$)', fontsize=18)
    # ax[0,1].legend(loc='lower right', ncol=2, fontsize=24)


    ax[0,2].plot(fr[0,:].reshape(-1,1),(am_vplist11[0,:]/xib/wr[0,:]/wr[0,:]).T,'r', label= '$R_l$ = 1 $\\Omega$')
    ax[0,2].plot(fr[0,:].reshape(-1,1),(am_vplist11[2,:]/xib/wr[0,:]/wr[0,:]).T,'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[0,2].plot(fr[0,:].reshape(-1,1),(am_vplist11[4,:]/xib/wr[0,:]/wr[0,:]).T,'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[0,2].plot(fr[0,:].reshape(-1,1),(am_vplist11[6,:]/xib/wr[0,:]/wr[0,:]).T,'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[0,2].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[11][0], lamB_list[11][0]), fontsize=24)
    ax[0,2].set_xlim(1,100)
    ax[0,2].set_yscale('log')
    # ax[0,2].set_xlabel('Base excitation frequency $f_b$')
    # ax[0,2].set_ylabel('Output voltage $|\\tilde{V}_p/(\\sigma^2 \\xi_b)|$ ($V \\cdot s^2 / m$)', fontsize=18)
    # ax[0,2].legend(loc='lower right', ncol=2, fontsize=24)


    ax[1,0].plot(fr[0,:].reshape(-1,1),(am_vplist13[0,:]/xib/wr[0,:]/wr[0,:]).T,'r', label= '$R_l$ = 1 $\\Omega$')
    ax[1,0].plot(fr[0,:].reshape(-1,1),(am_vplist13[2,:]/xib/wr[0,:]/wr[0,:]).T,'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[1,0].plot(fr[0,:].reshape(-1,1),(am_vplist13[4,:]/xib/wr[0,:]/wr[0,:]).T,'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[1,0].plot(fr[0,:].reshape(-1,1),(am_vplist13[6,:]/xib/wr[0,:]/wr[0,:]).T,'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[1,0].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[13][0], lamB_list[13][0]), fontsize=24)
    ...
    ax[1,1].plot(fr[0,:].reshape(-1,1),(am_vplist22[0,:]/xib/wr[0,:]/wr[0,:]).T,'r', label= '$R_l$ = 1 $\\Omega$')
    ax[1,1].plot(fr[0,:].reshape(-1,1),(am_vplist22[2,:]/xib/wr[0,:]/wr[0,:]).T,'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[1,1].plot(fr[0,:].reshape(-1,1),(am_vplist22[4,:]/xib/wr[0,:]/wr[0,:]).T,'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[1,1].plot(fr[0,:].reshape(-1,1),(am_vplist22[6,:]/xib/wr[0,:]/wr[0,:]).T,'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[1,1].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[22][0], lamB_list[22][0]), fontsize=24)
    ...
    # ax[1,1].legend(loc='lower right', ncol=2, fontsize=24)


    ax[1,2].plot(fr[0,:].reshape(-1,1),(am_vplist31[0,:]/xib/wr[0,:]/wr[0,:]).T,'r', label= '$R_l$ = 1 $\\Omega$')
    ax[1,2].plot(fr[0,:].reshape(-1,1),(am_vplist31[2,:]/xib/wr[0,:]/wr[0,:]).T,'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[1,2].plot(fr[0,:].reshape(-1,1),(am_vplist31[4,:]/xib/wr[0,:]/wr[0,:]).T,'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[1,2].plot(fr[0,:].reshape(-1,1),(am_vplist31[6,:]/xib/wr[0,:]/wr[0,:]).T,'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[1,2].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[31][0], lamB_list[31][0]), fontsize=24)
    ax[1,2].set_xlim(1,100)
    ax[1,2].set_yscale('log')
    ax[1,2].set_xlabel('Base excitation frequency $f_b$', fontsize=18)
    # ax[1,2].set_ylabel('Output voltage $|\\tilde{V}_p/(\\sigma^2 \\xi_b)|$ ($V \\cdot s^2 / m$)', fontsize=18)
    # ax[1,2].legend(loc='lower right', ncol=2, fontsize=24)
    ...
    ax[0,0].legend(bbox_to_anchor=(0.0, 1.10, 3.2, .102), loc=3, ncol=4, mode="expand", borderaxespad=0, fontsize=24)
    # plt.suptitle('Amplitude of the output voltage $V_p$ versus base excitation frequency $f_b$ at different $R_l$ and $\\lambda_B$', fontsize=24)
    plt.subplots_adjust(left=0.05, right=0.98, top=0.90, bottom=0.07, wspace=0.10, hspace=0.15)
...
def plot_pow_lamB_vs_fr_Rl():
    ...
    ax[0,1].plot(fr[0,:].reshape(-1,1),(am_pplist05[0,:]/xib/wr[0,:]/wr[0,:]).T,'r', label= '$R_l$ = 1 $\\Omega$')
    ax[0,1].plot(fr[0,:].reshape(-1,1),(am_pplist05[2,:]/xib/wr[0,:]/wr[0,:]).T,'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[0,1].plot(fr[0,:].reshape(-1,1),(am_pplist05[4,:]/xib/wr[0,:]/wr[0,:]).T,'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[0,1].plot(fr[0,:].reshape(-1,1),(am_pplist05[6,:]/xib/wr[0,:]/wr[0,:]).T,'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[0,1].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[5][0], lamB_list[5][0]), fontsize=24)
    ax[0,1].set_xlim(1,100)
    ax[0,1].set_yscale('log')
    # ax[0,1].set_xlabel('Base excitation frequency $f_b$')
    ...
    ax[0,2].plot(fr[0,:].reshape(-1,1),(am_pplist11[0,:]/xib/wr[0,:]/wr[0,:]).T,'r', label= '$R_l$ = 1 $\\Omega$')
    ax[0,2].plot(fr[0,:].reshape(-1,1),(am_pplist11[2,:]/xib/wr[0,:]/wr[0,:]).T,'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[0,2].plot(fr[0,:].reshape(-1,1),(am_pplist11[4,:]/xib/wr[0,:]/wr[0,:]).T,'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[0,2].plot(fr[0,:].reshape(-1,1),(am_pplist11[6,:]/xib/wr[0,:]/wr[0,:]).T,'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[0,2].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[11][0], lamB_list[11][0]), fontsize=24)
    ax[0,2].set_xlim(1,100)
    ax[0,2].set_yscale('log')
    # ax[0,2].set_xlabel('Base excitation frequency $f_b$')
    ...
    ax[1,0].plot(fr[0,:].reshape(-1,1),(am_pplist13[0,:]/xib/wr[0,:]/wr[0,:]).T,'r', label= '$R_l$ = 1 $\\Omega$')
    ax[1,0].plot(fr[0,:].reshape(-1,1),(am_pplist13[2,:]/xib/wr[0,:]/wr[0,:]).T,'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[1,0].plot(fr[0,:].reshape(-1,1),(am_pplist13[4,:]/xib/wr[0,:]/wr[0,:]).T,'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[1,0].plot(fr[0,:].reshape(-1,1),(am_pplist13[6,:]/xib/wr[0,:]/wr[0,:]).T,'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[1,0].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[13][0], lamB_list[13][0]), fontsize=24)
    ax[1,0].set_xlim(1,100)
    ax[1,0].set_yscale('log')
    ax[1,0].set_xlabel('Base excitation frequency $f_b$', fontsize=18)
    ...
    ax[1,1].plot(fr[0,:].reshape(-1,1),(am_pplist22[0,:]/xib/wr[0,:]/wr[0,:]).T,'r', label= '$R_l$ = 1 $\\Omega$')
    ax[1,1].plot(fr[0,:].reshape(-1,1),(am_pplist22[2,:]/xib/wr[0,:]/wr[0,:]).T,'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[1,1].plot(fr[0,:].reshape(-1,1),(am_pplist22[4,:]/xib/wr[0,:]/wr[0,:]).T,'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[1,1].plot(fr[0,:].reshape(-1,1),(am_pplist22[6,:]/xib/wr[0,:]/wr[0,:]).T,'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[1,1].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[22][0], lamB_list[22][0]), fontsize=24)
    ax[1,1].set_xlim(1,100)
    ax[1,1].set_yscale('log')
    ax[1,1].set_xlabel('Base excitation frequency $f_b$', fontsize=18)
    ...
    ax[1,2].plot(fr[0,:].reshape(-1,1),(am_pplist31[0,:]/xib/wr[0,:]/wr[0,:]).T,'r', label= '$R_l$ = 1 $\\Omega$')
    ax[1,2].plot(fr[0,:].reshape(-1,1),(am_pplist31[2,:]/xib/wr[0,:]/wr[0,:]).T,'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[1,2].plot(fr[0,:].reshape(-1,1),(am_pplist31[4,:]/xib/wr[0,:]/wr[0,:]).T,'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[1,2].plot(fr[0,:].reshape(-1,1),(am_pplist31[6,:]/xib/wr[0,:]/wr[0,:]).T,'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[1,2].set_title('$Y_e$={0:1.2e}, $\\lambda_B$={1:1.2e}'.format(Ye_list[31][0], lamB_list[31][0]), fontsize=24)
    ax[1,2].set_xlim(1,100)
    ax[1,2].set_yscale('log')
    ax[1,2].set_xlabel('Base excitation frequency $f_b$', fontsize=18)
...
def plot_vol_lamB_list_vs_fr_Rl():
    ...
    plt.suptitle("Amplitude of the output voltage $V_p$ versus externally connected resistance $R_l$ at different $f_b$ and $\\lambda_B$", fontsize=24)
...
def plot_pow_lamB_list_vs_fr_Rl():
    ...
    plt.text(0.02, 0.93, "(e)", fontweight="bold", transform=ax[1,1].transax, fontsize=24)
    plt.text(0.02, 0.93, "(f)", fontweight="bold", transform=ax[1,2].transax, fontsize=24)
    plt.suptitle("Amplitude of the output power $P_p$ versus externally connected resistance $R_l$ at different $f_b$ and $\\lambda_B$", fontsize=24)
...
def plot_vol_fr_sl_Rl_sl_vs_lamB():
    ...
    ax[0,0].plot(lamB_list.reshape(-1,1),(am_vplist[:, 0, 0]/xib/wr[0,0]/wr[0,0]).T, 'r-*', label='$R_l$ = 1 $\\Omega$')
    ax[0,0].plot(lamB_list.reshape(-1,1),(am_vplist[:, 2, 0]/xib/wr[0,0]/wr[0,0]).T, 'k-.s', label='$R_l$ = 100 $\\Omega$')
    ax[0,0].plot(lamB_list.reshape(-1,1),(am_vplist[:, 4, 0]/xib/wr[0,0]/wr[0,0]).T, 'm--d', label='$R_l$ = 10 k$\\Omega$')
    ax[0,0].plot(lamB_list.reshape(-1,1),(am_vplist[:, 6, 0]/xib/wr[0,0]/wr[0,0]).T, 'b-o', label='$R_l$ = 1 M$\\Omega$')
    ...
    # plt.suptitle('Amplitude of the output voltage $V_p$ versus bending stiffness ratio $\\lambda_B$ at different $f_b$ and $R_l$', fontsize=24)
...
def plot_pow_fr_sl_Rl_sl_vs_lamB():
    ...
    ax[0,0].plot(lamB_list.reshape(-1,1),(am_pplist[:, 0, 0]/xib/wr[0,0]/wr[0,0]).T, 'r-*', label='$R_l$ = 1 $\\Omega$')
    ax[0,0].plot(lamB_list.reshape(-1,1),(am_pplist[:, 2, 0]/xib/wr[0,0]/wr[0,0]).T, 'k-.s', label='$R_l$ = 100 $\\Omega$')
    ax[0,0].plot(lamB_list.reshape(-1,1),(am_pplist[:, 4, 0]/xib/wr[0,0]/wr[0,0]).T, 'm--d', label='$R_l$ = 10 k$\\Omega$')
    ax[0,0].plot(lamB_list.reshape(-1,1),(am_pplist[:, 6, 0]/xib/wr[0,0]/wr[0,0]).T, 'b-o', label='$R_l$ = 1 M$\\Omega$')
    ax[0,0].yaxis.set_major_formatter(yfmt)
    ax[0,0].set_xscale('log')
    ax[0,0].set_yscale('log')
    # ax[0,0].set_ylim(1e-10,1e-1)
