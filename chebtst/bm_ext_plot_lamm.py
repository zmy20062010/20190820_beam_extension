...
def plot_vol_lamm_vs_fr_Rl():
    ...
    ax[0,0].plot(fr[0,:],am_vplist01[0,:],'r', label= '$R_l$ = 1 $\\Omega$')
    ax[0,0].plot(fr[0,:],am_vplist01[2,:],'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[0,0].plot(fr[0,:],am_vplist01[4,:],'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[0,0].plot(fr[0,:],am_vplist01[6,:],'k--', label= '$R_l$ = 1 M$\\Omega$')
    ...
    ax[1,0].plot(fr[0,:],am_vplist03[0,:],'r', label= '$R_l$ = 1 $\\Omega$')
    ax[1,0].plot(fr[0,:],am_vplist03[2,:],'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[1,0].plot(fr[0,:],am_vplist03[4,:],'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[1,0].plot(fr[0,:],am_vplist03[6,:],'k--', label= '$R_l$ = 1 M$\\Omega$')
    ...
    ax[1,1].plot(fr[0,:],am_vplist04[0,:],'r', label= '$R_l$ = 1 $\\Omega$')
    ax[1,1].plot(fr[0,:],am_vplist04[2,:],'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[1,1].plot(fr[0,:],am_vplist04[4,:],'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[1,1].plot(fr[0,:],am_vplist04[6,:],'k--', label= '$R_l$ = 1 M$\\Omega$')
    ...
    plt.suptitle('Amplitude of the output voltage $V_p$ versus base excitation frequency $fr$ at different $R_l$ and $\\lambda_m$', fontsize=24)
...
def plot_pow_lamm_vs_fr_Rl():
    ...
    ax[0,0].plot(fr[0,:],am_pplist01[0,:],'r', label= '$R_l$ = 1 $\\Omega$')
    ax[0,0].plot(fr[0,:],am_pplist01[2,:],'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[0,0].plot(fr[0,:],am_pplist01[4,:],'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[0,0].plot(fr[0,:],am_pplist01[6,:],'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[0,0].set_title('$\\rho_e$={0:1.2e}, $\\lambda_m$={1:1.2e}'.format(rhoe_list[0][0], 
        lamm_list[0][0]), fontsize=18)
    ax[0,0].set_xlim(1,100)
    ax[0,0].set_yscale('log')
    ...
    ax[1,0].plot(fr[0,:],am_pplist03[0,:],'r', label= '$R_l$ = 1 $\\Omega$')
    ax[1,0].plot(fr[0,:],am_pplist03[2,:],'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[1,0].plot(fr[0,:],am_pplist03[4,:],'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[1,0].plot(fr[0,:],am_pplist03[6,:],'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[1,0].set_title('$\\rho_e$={0:1.2e}, $\\lambda_m$={1:1.2e}'.format(rhoe_list[2][0], 
        lamm_list[2][0]), fontsize=18)
    ax[1,0].set_xlim(1,100)
    ax[1,0].set_yscale('log')
    ...
    ax[1,1].plot(fr[0,:],am_pplist04[0,:],'r', label= '$R_l$ = 1 $\\Omega$')
    ax[1,1].plot(fr[0,:],am_pplist04[2,:],'b.', label= '$R_l$ = 100 $\\Omega$')
    ax[1,1].plot(fr[0,:],am_pplist04[4,:],'m*', label= '$R_l$ = 10 k$\\Omega$')
    ax[1,1].plot(fr[0,:],am_pplist04[6,:],'k--', label= '$R_l$ = 1 M$\\Omega$')
    ax[1,1].set_title('$\\rho_e$={0:1.2e}, $\\lambda_m$={1:1.2e}'.format(rhoe_list[3][0], 
        lamm_list[3][0]), fontsize=18)
    ax[1,1].set_xlim(1,100)
    ax[1,1].set_yscale('log')
    ...
    plt.text(0.02, 0.93, "(c)", fontweight="bold", transform=ax[1,0].transAxes, fontsize=24)
    plt.text(0.02, 0.93, "(d)", fontweight="bold", transform=ax[1,1].transAxes, fontsize=24)
    plt.suptitle('Amplitude of the output power $P_p$ versus base excitation frequency $fr$ at different $R_l$ and $\\lambda_m$', fontsize=24)
    plt.subplots_adjust(left=0.05, right=0.98, top=0.90, bottom=0.07, wspace=0.08, hspace=0.17)
...
def plot_vol_lamm_list_vs_fr_Rl():
    ...
    plt.suptitle("Amplitude of the output voltage $V_p$ versus externally connected resistance $R_l$ at different $fr$ and $\\lambda_m$", fontsize=24)
...
def plot_pow_lamm_list_vs_fr_Rl():
    ...
    plt.text(0.02, 0.93, "(d)", fontweight="bold", transform=axes[1,0].transAxes, fontsize=24)
    plt.text(0.02, 0.93, "(e)", fontweight="bold", transform=axes[1,1].transAxes, fontsize=24)
    plt.suptitle("Amplitude of the output power $P_p$ versus externally connected resistance $R_l$ at different $fr$ and $\\lambda_m$", fontsize=24)
