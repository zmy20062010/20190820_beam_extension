...
To address the urgent issues of global warming, environmental pollution, and depleting energy resources, researchers have been continuously exploring clean, renewable, and sustainable energy sources, including solar energy, bio-energy, nuclear energy and etc. Extracting energy from ambient environment to power electronic devices, which is also called energy harvesting, has also been a hot research topic in the past few decades. Lots of energy harvesting devices have been put forward to convert ambiently available energy, like vibration energy, thermal energy, solar energy, and etc., into electrical energy. Among all the devices, vibration energy harvesting devices have been the most popular ones due to the universal and versatile presence of vibraiton energy in the ambient environment. 

According to the underlying physical principles and materials used in the devices, vibration energy harvesting devices can roughly be classified into several categories: electromagnetic energy harvesting devices, electrostatic energy harvesting devices, piezoelectric energy harvesting devices, and triboelectric energy harvesting devices []. 


Among all the proposed energy harvesting devices, piezoelectric ones has been the focus of many researchers because of their simple operation mechanism and ease of fabrication.
