...
As shown in Figure~\ref{fig:fig_pveh}, a typical PVEH is composed of composite cantilever beam and attached to a host structure. An external pure resistance is connected to piezoelectric elements, usually in the forms of films or plates. Actually, this is a little bit of an oversimplification in the sense that practical electrical loads usually involves capacitors and inductors and that some interface circuits and power management circuits are usually needed to achieve a better energy harvesting performance. \textcolor{red}{refs to be added} Nonetheless, the pure resistant load is widely used for the sake of simplicity.

\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{./img_eig_asy/fig_pveh}
    \caption{Schematic diagram of a typical PVEH.}
    \label{fig:fig_pveh}
\end{figure}
