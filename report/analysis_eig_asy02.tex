...
A different yet improved approach is to resort to the Rayleigh-Ritz method. 


the eigenfunction expansion method. In this approach, electromechanical model of the PVEHs is established based on the generalized Hamilton's principle. \cite{crandall1968dynamics} 
...
theory of functional analysis, \cite{kreyszig1978introductory} the variational formulation is converted into an infinite-dimension matrix-form state space model 


and then truncated using the Rayleigh-Ritz method \cite{hagood1990modelling} to obtain 


finite element modeling method. 

\cite{sodano2004estimation,lu2003modeling,chen2006analytical,ajitsaria2007modeling}
